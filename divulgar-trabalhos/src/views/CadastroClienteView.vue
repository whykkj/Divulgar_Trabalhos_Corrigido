  ...
  <main class="min-h-screen bg-slate-100 flex justify-center">
    ...
    >
      ...
      <div class="text-center pt-2 mb-7">
        ...
        >
          Crie sua conta para encontrar os melhores serviços da sua região.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <button
            ...
            class="group relative w-full overflow-hidden bg-[#D94E1E] text-white px-4 py-3.5 rounded-xl font-bold text-sm shadow-sm transition-all duration-200 hover:bg-[#C34418] hover:-translate-y-0.5 hover:shadow-lg active:scale-[0.97] disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0"
          >
            <span
              v-if="!cadastrando"
              class="relative z-10"
