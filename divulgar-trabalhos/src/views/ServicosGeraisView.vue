            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xs sm:text-sm text-slate-500 mt-0.5">
                  Soluções práticas para sua casa
                </p>
              </div>
            </div>
          ...
          <div class="relative z-10 flex items-center justify-between gap-4">
            <div class="max-w-[600px]">
              ...
              <h3 class="text-lg sm:text-xl font-bold mt-1">
                Precisa resolver algo rapidamente?
              </h3>

              <p class="text-xs sm:text-sm text-orange-50 mt-1">
                Encontre profissionais disponíveis para pequenos reparos,
        ...
        <section class="flex flex-col gap-3">
          ...
          >
            ...
            <div class="flex gap-2 mt-4">
              <button
                type="button"
                class="flex-1 min-h-11 rounded-xl px-3 text-xs sm:text-sm font-bold flex items-center justify-center gap-2 transition active:scale-[0.98]"
                :class="
                  profissional.emergencia
                    ? 'bg-[#D94E1E] hover:bg-[#C34418] text-white shadow-sm'
                    : 'bg-[#FFF1EB] hover:bg-[#FFE5DC] text-[#D94E1E]'
                "
        ...
        >
          ...
          <div>
            <h3 class="text-sm font-bold">
              Encontre profissionais para o dia a dia
            </h3>

            <p class="text-xs text-slate-500 mt-1 leading-relaxed">
              Compare categorias, avaliações, distância e disponibilidade
              para encontrar o serviço que melhor combina com sua necessidade.
            </p>
          </div>
        </section>
      </div>
